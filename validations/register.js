...
const registerValidator = Yup.object().shape({
    ...
    email: Yup.string().email('لطفا یک ایمیل معتبر وارد کنید').min(10, 'ایمیل نباید کمتر از 10 کاراکتر باشد').max(20, 'ایمیل نباید بیشتر از 20 کاراکتر باشد').required('لطفا یک آدرس ایمیل وارد کنید'),
